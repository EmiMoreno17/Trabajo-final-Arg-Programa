      ...
      <div className="row gap-4">
        {categorias.map((categoria,index)=>(
          <div className="col d-flex justify-content-center p-0" key={index}>
            <button onClick={() => OnSelectedCategory(categoria.nombre)} className="border border-1 border-black d-flex gap-1 align-items-center rounded p-1 text-decoration-none" style={{cursor: 'pointer'}}>{categoria.icono } {categoria.nombre} </button>
